...
There are still some more texture loading incorrectly in UI that I havent been able to tackle yet, this current fix uses the [0.18.0 release](https://github.com/shadps4-emu/shadPS4/releases/tag/v.0.18.0) maybe I will update if newer release manages to solves said problems. 
